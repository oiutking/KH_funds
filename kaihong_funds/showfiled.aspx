<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showfiled.aspx.cs" Inherits="kaihong_funds.showfiled" %>
                                                ...
                                                <ItemTemplate>
                                                    <tr class="unread">
                                                            <td class="span3">
                                                                ...
                                                                <td class="span2">
                                                                <%#Eval("prnt").ToString()%>次
                                                                </td>
                                                                <td class="span1">
                                                                <%#Convert.ToDateTime( Eval("make_date")).ToShortDateString()%>
                                                                </td>
                                                                <td class="span1">
